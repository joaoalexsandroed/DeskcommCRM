-- ============================================================================
-- 0161 — AS DUAS CAMADAS DE SEGURANÇA QUE CUSTAM DINHEIRO PASSAM A SER ESCOLHA
-- DA ORGANIZAÇÃO.
--
-- Renumerada de 0142 na integração do upstream com este fork — 0142 já estava
-- em uso por `0142_definer_nova_nasce_exposta` (renumerada de 0116 numa
-- integração anterior). Toda referência a "a 0142" nos comentários de outras
-- migrations relativa a ESTA migration (camadas de segurança / guardrail
-- layers) passa a ser "a 0161".
--
