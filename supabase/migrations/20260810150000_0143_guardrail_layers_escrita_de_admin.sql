...
--
-- Forward-fix da 0161, que criou `public.org_guardrail_layers` com UMA policy
...
--
-- O raciocínio que produziu o furo estava escrito na própria 0161: "nenhuma função
...
--
-- Por que forward-fix e não edição da 0161: a 0161 foi publicada na `main` (PR #218,
...
-- serve tanto para quem está na 0161 quanto para quem já rodou este arquivo.
-- ============================================================================
